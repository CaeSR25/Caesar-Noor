# -*- coding: utf-8 -*-
"""Prak5 Brightness dan kontras.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Q1onUljny-mKSF4kgr4-Wyowzl1-8NQt
...
# membaca gambar
img = imageio.imread("Vs.png")

# menampilkan resolusi dan type gambar
...
# Parameter ditambahkan dengan nilai brightness
def brighter(nilai):
...
# Menambahkan brightness dengan 100 dan (-100)
brighter(-100)
...
# menambahkan nilai brightness dengan parameter
...
# menampilkan hasil gambar btightness rgb dengan nilai (-100) dan 100
rgbbrighter(-100)
...
# variable gambar kontras
img_contrass = np.zeros(img.shape, dtype=np.uint8)

# menambah nilai kontras dengan nilai parameter
def contrass(nilai):
    for y in range(0, img_height):
        for x in range(0, img_width):
            red = img[y][x][0]
...
# menampilkan hasil gambar kontras
contrass(2)
...
# Variable img contrass
img_autocontrass = np.zeros(img.shape, dtype=np.uint8)

# menambah nilai contrass gambar dengan otomatis
def autocontrass():
    xmax = 300
    xmin = 0
    d = 0
...
# menampilkan hasil contrass otomatis
autocontrass()
