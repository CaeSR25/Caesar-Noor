...
Original file is located at
    https://colab.research.google.com/drive/18_9uDWPCFnm7AXP_m1JPziR0_2gDm-3p
...
boost = cv2.imread('B.jpg')
boost = cv2.cvtColor(boost, cv2.COLOR_BGR2RGB) # simpan dengan nama yang sama = ditumpuk

# panggil dan konversi warna agar sesuai dengan Matplotlib
all = cv2.imread('Af.jpg')
all = cv2.cvtColor(all, cv2.COLOR_BGR2RGB)
plt.subplot(121),plt.imshow(boost), plt.title('Boost form')
plt.subplot(122),plt.imshow(all), plt.title('All form')
plt.show()
