# -*- coding: utf-8 -*-
"""Menghitung deteksi dengan template matching.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1eOMNWoRFMyqVhG-irZmwlxcecGqe_iXf

120707070025 Caesar Noor
"""
...
gear = cv2.imread('Gear.jpg')
gear = cv2.cvtColor(gear, cv2.COLOR_BGR2RGB)
# panggil dan konversi warna agar sesuai dengan Matplotlib
ninja = cv2.imread('Ninja.jpg')
ninja = cv2.cvtColor(ninja, cv2.COLOR_BGR2RGB)
plt.subplot(121),plt.imshow(gear), plt.title('Gear')
plt.subplot(122),plt.imshow(ninja), plt.title('Body Ninja')
plt.show()
...
img_rgb = cv2.imread('Ninja.jpg')
img_gray = cv2.cvtColor(img_rgb, cv2.COLOR_BGR2GRAY)

## membaca template
template = cv2.imread('Gear.jpg',0)
