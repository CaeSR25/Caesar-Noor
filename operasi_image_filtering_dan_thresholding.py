# -*- coding: utf-8 -*-
"""Operasi Image Filtering dan Thresholding.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Up9n3L3oXtBXVPtC3X4GUuAu7raHpyuO
...
#bgr
img = cv2.imread('Electrua.jpg')

#rgb
electrua = cv2.cvtColor(img, cv2.COLOR_BGR2RGB)
...
# lakukan filtering
electrua_filter = cv2.filter2D(img,-1,kernel)

cv2_imshow(electrua_filter)
...
plt.subplot(121),plt.imshow(electrua),plt.title('Original')
plt.xticks([]), plt.yticks([])

# kedua, hasil filter
plt.subplot(122),plt.imshow(electrua_filter),
plt.title('Averaging')
plt.xticks([]), plt.yticks([])
...
#img = cv2.imread('images/Electrua.jpg',0)
